        ...
        <nav class="main-menu">
            <ul class="nav metismenu">
                <li class="nav-dropdown active">
                    <a class="has-arrow" href="#" aria-expanded="false"><i class="icon dripicons-view-thumb"></i><span>Menu</span></a>
                    <ul class="collapse in nav-sub" aria-expanded="true">
                        <li><a href="{{route('mobil.index')}}"><span>Mobil</span></a></li>
                        <li><a href="{{route('pemesanan.index')}}"><span>Pesanan Anda</span></a></li>
                    </ul>
                </li>
            </ul>
        </nav>
